...
class TestRetryStrategy:
    ...
    def test_max_delay_cap(self):
        ...
        strategy = RetryStrategy(initial_delay_seconds=60, max_delay_seconds=300, backoff_factor=2.0, jitter_factor=0.0)
    ...
    def test_jitter_adds_randomness(self):
        ...
        strategy = RetryStrategy(initial_delay_seconds=100, jitter_factor=0.2)
    ...
    def test_retry_window_reset(self):
        ...
        strategy = RetryStrategy(max_retry_attempts=3, retry_window_hours=1)
    ...
    def test_get_next_retry_time(self):
        ...
        strategy = RetryStrategy(initial_delay_seconds=60, jitter_factor=0.0)
...
class TestUsageLimitRetryInfo:
    ...
    def test_retry_strategy_integration(self):
        ...
        strategy = RetryStrategy(initial_delay_seconds=120, jitter_factor=0.0)

        info = UsageLimitRetryInfo(message="Limit reached", retry_strategy=strategy)
