...
def mock_agent_states():
    ...
    states = {
        ...
        "working": {
            ...
            "runs": 1,
            "events": [
                AgentEvent(event_type="started", message="Agent started"),
                AgentEvent(event_type="prompt_sent", message="Working on tests")
            ],
            "usage_limit_hits": 0
        },
        "completed_once": {
            ...
            "events": [
                AgentEvent(event_type="started", message="Agent started"),
                AgentEvent(event_type="task_completed", message="Tests implemented")
            ],
            "usage_limit_hits": 0
        },
        "usage_limited": {
            ...
            "runs": 2,
            "events": [
                AgentEvent(event_type="usage_limit", message="Limit hit at 3:45 PM")
            ],
            "usage_limit_hits": 1,
            "usage_limit_info": UsageLimitInfo(
                message="Try again at 3:45 PM PST",
        ...
        "error_state": {
            ...
            "runs": 1,
            "events": [
                AgentEvent(event_type="error", message="Firebase connection failed")
            ],
            "usage_limit_hits": 0
        }
    }
